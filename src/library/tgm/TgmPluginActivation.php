...
if (! class_exists('TGM_Plugin_Activation')) {
    ...
    class TGM_Plugin_Activation
    {
        ...
        public function notices()
        {
            ...
            if (! empty($message)) {
                ...
                foreach ($message as $type => $plugin_group) {
                    ...
                    $linked_plugins = array_map([ 'TGM_Utils', 'wrap_in_em' ], $linked_plugins);
         ...
         * @since 2.1.0
         *
<<<<<<< 2c8719843385c86c559000d8d7a0e5c2a642f09e
         * @return TGM_Plugin_Activation The TGM_Plugin_Activation object.
=======
         * @return boolean True when on the TGMPA page, false otherwise.
>>>>>>> 8df9cec1708219c8264f70a9469fff7e9af26093
         */
        ...
        public function process_bulk_actions()
        {
            ...
            if ('tgmpa-bulk-activate' === $this->current_action()) {
                ...
                if (is_wp_error($activate)) {
                    ...
                    $plugin_names = array_map([ 'TGM_Utils', 'wrap_in_strong' ], $plugin_names);
