...
if ( ! class_exists( 'TgmPluginActivation' ) ) {
    ...
    class TgmPluginActivation {
         ...
         * @since 2.4.0
         *
         * @return object The TgmPluginActivation object.
         */
        public static function get_instance() {

            if ( ! isset( self::$instance ) && ! ( self::$instance instanceof TgmPluginActivation ) ) {
                self::$instance = new TgmPluginActivation();
            }
    ...
    $tgmpa = TgmPluginActivation::get_instance();
...
if ( ! function_exists( 'tgmpa' ) ) {
    ...
    function tgmpa( $plugins, $config = array() ) {
        ...
        if ( $config ) {
            TgmPluginActivation::$instance->config( $config );
        }
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
    ...
    class TGMPA_List_Table extends WP_List_Table {
         ...
         * and stores it in the global object TgmPluginActivation::$instance.
         *
         * @since 2.2.0
         *
        ...
        protected function _gather_plugin_data() {
            ...
            TgmPluginActivation::$instance->admin_init();
            TgmPluginActivation::$instance->thickbox();
            ...
            foreach ( TgmPluginActivation::$instance->plugins as $plugin ) {
                if ( is_plugin_active( $plugin['file_path'] ) ) {
        ...
        protected function _get_plugin_data_from_name( $name, $data = 'slug' ) {
            ...
            foreach ( TgmPluginActivation::$instance->plugins as $plugin => $values ) {
                if ( $name == $values['name'] && isset( $values[$data] ) ) {
                    return $values[$data];
                }
            }
                    ...
                    'install' => sprintf(
                        ...
                        esc_url(
                            wp_nonce_url(
                                add_query_arg(
                                    array(
                                        'page'          => urlencode( TgmPluginActivation::$instance->menu ),
        ...
        public function column_cb( $item ) {
            ...
            if ( __( 'Private Repository', 'tgmpa' ) === $item['source'] ) {
                ...
                $plugin_url = urlencode( TgmPluginActivation::$instance->default_path . $plugin_url );
            }
        ...
        public function process_bulk_actions() {
            ...
            if ( 'tgmpa-bulk-install' === $this->current_action() ) {
                ...
                if ( is_wp_error( $api ) ) {
                    wp_die( TgmPluginActivation::$instance->strings['oops'] . var_dump( $api ) );
                }
                ...
                $url   = esc_url_raw( add_query_arg( array( 'page' => urlencode( TgmPluginActivation::$instance->menu ) ), network_admin_url( 'themes.php' ) ) );
                $nonce = 'bulk-plugins';
                $names = $plugin_names;
...
if ( ! function_exists( 'tgmpa_load_bulk_installer' ) ) {
     ...
     * @since 2.2.0
     */
    if ( ! class_exists( 'WP_Upgrader' ) && ( isset( $_GET['page'] ) && TgmPluginActivation::$instance->menu === $_GET['page'] ) ) {
        ...
        if ( ! class_exists( 'TGM_Bulk_Installer' ) ) {
            ...
            class TGM_Bulk_Installer extends WP_Upgrader {
                ...
                public function bulk_install( $packages ) {
                    ...
                    if ( TgmPluginActivation::$instance->is_automatic ) {
                ...
                public function run( $options ) {
                    ...
                    if ( ! $res ) {
                        ...
                        if ( TgmPluginActivation::$instance->is_automatic ) {
                            ...
                            TgmPluginActivation::$instance->populate_file_path();
            ...
            if ( ! class_exists( 'TGM_Bulk_Installer_Skin' ) ) {
                ...
                class TGM_Bulk_Installer_Skin extends Bulk_Upgrader_Skin {
                    ...
                    public function bulk_footer() {
                        ...
                        foreach ( TgmPluginActivation::$instance->plugins as $plugin ) {
                            if ( ! is_plugin_active( $plugin['file_path'] ) ) {
                                echo '<p><a href="' . esc_url( add_query_arg( 'page', urlencode( TgmPluginActivation::$instance->menu ), network_admin_url( 'themes.php' ) ) ) . '" title="' . esc_attr( TgmPluginActivation::$instance->strings['return'] ) . '" target="_parent">' . TgmPluginActivation::$instance->strings['return'] . '</a></p>';
                                $complete[] = $plugin;
                                break;
                            }
                            // Nothing to store.
                        ...
                        if ( empty( $complete ) ) {
                            echo '<p>' .  sprintf( TgmPluginActivation::$instance->strings['complete'], '<a href="' . esc_url( network_admin_url() ) . '" title="' . esc_attr__( 'Return to the Dashboard', 'tgmpa' ) . '">' . __( 'Return to the Dashboard', 'tgmpa' ) . '</a>' ) . '</p>';
                            echo '<style type="text/css">#adminmenu .wp-submenu li.current { display: none !important; }</style>';
                        }
